...
if (isset($_POST['login'])) {
    ...
    $query = "select * from renter where renter_name = '$name' and renter_password = '$password '";
    echo $query;
    $run_query = mysqli_query($con, $query);
    $count_rows = mysqli_num_rows($run_query);
    if ($count_rows == 0) {
        echo "<script>alert('Please Enter Valid Details');</script>";
        echo "<script>window.open('renterlogin.php','_self')</script>";
    }
    ...
    $_SESSION['name'] = $name;
    echo "<script>window.open('../renterhome.php','_self')</script>";
}
...
<body>
  <div class="login_div" id="new1">
    ...
    <p>Login Here</p>
    <from calss="login_form" action="renterlogin.php" method="post">
        ...
        <div>
        <a id='link' href="renterhome.php">
            <button name="login" value="Login">Login</button></a>
            <a id='link' href="renterregistration.php">
